...
// Authenticate to nxapi-znca-api.fancy.org.uk using the nxapi CLI client.
// The npm package signs JWTs with 32 zero bytes (no embedded release key),
// but nxapi-auth.fancy.org.uk accepts zero-signed JWTs from the CLI client ID
// — so this works correctly even from the npm package.
